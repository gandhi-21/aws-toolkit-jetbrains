...
import software.aws.toolkits.jetbrains.uitests.amazonqdoc.scripts.updateReadmeAcceptChangesTestScript
import software.aws.toolkits.jetbrains.uitests.amazonqdoc.scripts.updateReadmeConfirmOptionsTestScript
import software.aws.toolkits.jetbrains.uitests.amazonqdoc.scripts.updateReadmeMakeChangesTestScript
import java.io.File
...
class AmazonQDocUpdateCodeChangesFlowTest {
    init {
        di = DI {
            extend(di)
