...
import software.aws.toolkits.jetbrains.uitests.amazonqdoc.scripts.rejectDocScript
import java.io.File
    ...
    fun `can create README in doc`() {
        ...
        Starter.newContext(CurrentTestMethod.hyphenateWithClass(), testCase).apply {
            ...
            .useDriverAndCloseIde {
                ...
                executeScript(rejectDocScript)

                val readmeFile = File(readmePath)
                assert(!readmeFile.exists()) { "README.md file should not exist" }
            }
    }
}
